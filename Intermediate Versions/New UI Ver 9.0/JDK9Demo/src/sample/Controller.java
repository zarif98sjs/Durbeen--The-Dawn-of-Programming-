...
public class Controller implements Initializable {
    ...
    public void init_change_sprite() {
        ...
        b2.setOnMouseClicked(event -> {
            ...
            back_image.maxWidth(600);
            back_image.maxHeight(430);
            /*back_image.setFitWidth(600);
            back_image.setFitHeight(430);*/
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        File file = new File("src/img/catsp.png");
        ...
        back_image.setOnMouseClicked(me->{
            ...
            try {
                //System.out.println("Color is : "+kon_color(me.getX(),me.getY()));
                color_label.setText(kon_color(me.getX(),me.getY()));
