...
public class SpriteView extends ImageView implements Serializable {
    ...
    public String kon_color(double x, double y)
    {
        ...
        if      (hsb[1] < 0.1 && hsb[2] > 0.9) final_color="White";
        else if (hsb[2] < 0.1) final_color="Black";
        else {
            float deg = hsb[0]*360;
            if      (deg >=   0 && deg <  30) final_color="Red";
            else if (deg >=  30 && deg <  90) final_color="Yellow";
            else if (deg >=  90 && deg < 150) final_color="Green";
            else if (deg >= 150 && deg < 210) final_color="Cyan";
            else if (deg >= 210 && deg < 270) final_color="Blue";
            else if (deg >= 270 && deg < 330) final_color="Magenta";
            else final_color="Red";
        }
