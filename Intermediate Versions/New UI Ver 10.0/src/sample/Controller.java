...
public class Controller implements Initializable {
    ...
    public void init_change_sprite() {
        ...
        vb.getChildren().setAll(b1, b2, b3);
    ...
    public static void getCodeBox(String r) throws Exception {
        ...
        staticAnchor.getChildren().add(c);
        //codeAnchorBox = c;
    ...
    /*public static void initiate(String filePath, String sprite, String back){
        spriteView.setImage(new Image(new File(sprite).toURI().toString()));
        backImageView.setImage(new Image(new File(back).toURI().toString()));
...
/*
                            ...
                            case "JODI":
                                ...
                                spriteView.shob_color_er_upor_aase_kina();
 */