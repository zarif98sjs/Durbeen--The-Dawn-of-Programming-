...
public class SagaOfStyle {
   ...
   /* public void init_text_button_for_looks() {
    ...
    public void init_motion() {
        ...
        //btn[4].setText("মাউসের দিকে ঘোরো");
        /*btn[5].setText("ভুজ ঠিক করো");
        btn[6].setText("কোটি ঠিক করো");*/
        btn[4].setText("অপেক্ষা করো");
    ...
    public void init_looks() {
        ...
        vb.getChildren().setAll(btn[2], btn[3]);
    }
    ...
    public void initConditionButton() {
        ...
        btn[8].setText("যদি এই রঙ না হয়");

        ChoiceBox<String> colorChoiceBox = new ChoiceBox<>();
        colorChoiceBox.getItems().add("লাল");
        colorChoiceBox.getItems().add("নীল");
        colorChoiceBox.getItems().add("সবুজ");
        colorChoiceBox.getItems().add("কালো");
        colorChoiceBox.getItems().add("সাদা");
        colorChoiceBox.getItems().add("আকাশি");
        colorChoiceBox.getItems().add("গোলাপি");
        colorChoiceBox.getItems().add("হলুদ");
        btn[7].setGraphic(colorChoiceBox);

        ChoiceBox<String> colorChoiceBox2 = new ChoiceBox<>();
        colorChoiceBox2.getItems().add("লাল");
        colorChoiceBox2.getItems().add("নীল");
        colorChoiceBox2.getItems().add("সবুজ");
        colorChoiceBox2.getItems().add("কালো");
        colorChoiceBox2.getItems().add("সাদা");
        colorChoiceBox2.getItems().add("আকাশি");
        colorChoiceBox2.getItems().add("গোলাপি");
        colorChoiceBox2.getItems().add("হলুদ");
        btn[8].setGraphic(colorChoiceBox2);
        ...
        btn[8].setNodeOrientation(NodeOrientation.RIGHT_TO_LEFT);
        colorChoiceBox.setNodeOrientation(NodeOrientation.LEFT_TO_RIGHT);
        colorChoiceBox2.setNodeOrientation(NodeOrientation.LEFT_TO_RIGHT);
        vb.getChildren().addAll(btn[7],btn[8]);
    }
