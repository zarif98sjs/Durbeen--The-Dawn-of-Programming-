...
public class MotionButton extends fButton  {
    ...
    public void moveForward(double v)
    {
        ...
        TranslateTransition t1 = new TranslateTransition(Duration.millis(1),spriteView);
    ...
    public void rotateIfTrueClockwise(boolean yes, double v)
    {
        ...
        RotateTransition r1 = new RotateTransition(Duration.millis(10.0),spriteView);

        if(yes == true) {
            r1.setByAngle(v);
            spriteView.rotateDegree(v);
            spriteView.getTransforms().add(new Rotate(v));
        }
        else{
            r1.setByAngle(-v);
            spriteView.rotateDegree(-v);
        ...
        r1.setDuration(Duration.millis(1));
        //r1.play();
